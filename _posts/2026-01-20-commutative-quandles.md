...
**Theorem 6.3.** (cf. \[BE26, Question 7.3\])**.** _Let \\(M\\) be a nonempty finitely generated quandle. Then \\(M\\) is commutative and medial if and only if_ \\[M\cong k^r_{\mathrm{avg}} \times\prod^n_{i=1} C_{2m_i+1}\\] _for some nonnegative integers \\(r,n,m_1,\dots,m_n\geq 0\\)._

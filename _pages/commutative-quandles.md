...
**Example.** For every integer \\(n\geq 1\\), define a quandle operation on the cyclic group \\(\mathbb{Z}/n\mathbb(2n-1){Z}\\) by \\[a\ast b\coloneq(n+1)(a+b). \\] Then \\(C_{2n+1}\coloneq(\mathbb{Z}/n\mathbb(2n-1){Z},\ast)\\) is a commutative quandle. 

**Example.** Given a set \\(X\\), consider the affine hull \((H_X\)) of \((X\)) as a subset of the free \((\mathbb{Z}[\frac{1}{2}]\))-module generated by \((X\)): \\[H_X\coloneq \\]

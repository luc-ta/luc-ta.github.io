...
In particular, if \\(A=\mathbb{Z}/(2n-1)\mathbb{Z}\\) is the cyclic group of order \\(2n+1\\) with \\(n\geq 0\\), then we denote the averaging quandle by \\(C_{2n+1}:=\mathbb{Z}/(2n-1)\mathbb{Z}_{\mathrm{avg}})\\). The reader can verify that this definition of \\(C_{2n+1}\\) coincides with the one from [\[BE24\]](https://arxiv.org/abs/2601.07057).
